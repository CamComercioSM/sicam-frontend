    ...
    <div class="tab-content p-0">
        ...
        <div class="d-flex mb-4 gap-4">
          <div class="avatar avatar-md">
            <div class="avatar-initial bg-label-primary rounded">
              <i class="icon-base ri ri-bank-card-line icon-28px"></i>
            </div>
          </div>
          <div>
            <h5 class="mb-1">
      ...
      <div class="tab-pane fade" id="orders" role="tabpanel">
        <div class="d-flex mb-4 gap-4 align-items-center">
          <div class="avatar avatar-md">
            <span class="avatar-initial bg-label-primary rounded">
              <i class="icon-base ri ri-inbox-archive-line icon-24px"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-1">
      ...
      <div class="tab-pane fade" id="product" role="tabpanel">
        <div class="d-flex mb-4 gap-4 align-items-center">
          <div class="avatar avatar-md">
            <span class="avatar-initial bg-label-primary rounded">
              <i class="icon-base ri ri-settings-4-line icon-24px"></i>
            </span>
          </div>
          <div>
            <h5 class="mb-1">
